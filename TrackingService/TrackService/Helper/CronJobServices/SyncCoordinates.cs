...
namespace TrackService.Helper.CronJobServices
{
    public class SyncCoordinates : CronJobService
    {
        ...
        public SyncCoordinates(IScheduleConfig<SyncCoordinates> config, IThreadStatsChangefeedDbService threadStatsChangefeedDbService) : base(config.CronExpression, config.TimeZoneInfo)
        {
